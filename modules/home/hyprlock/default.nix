...
with lib; {
  options.programs.hyprlock = {
    ...
    package = mkOption {
      type = types.package;
      default = pkgs-unstable.hyprlock;
      defaultText = literalExpression "pkgs-unstable.hyprlock";
      description = "The package to use for hyprlock.";
    };
  ...
  in {
    xdg.configFile."hypr/hyprlock.conf".text = mkIf hyprlock.enable ''
background {
    monitor =
    path = screenshot
